...
export default {
  ...
  mounted () {
    this.$nextTick(() => {
      ...
      if (this.decimalsType == 0) {
        this.counter = new CountUp(this.counterId, this.startVal, endVal, 0, this.duration, {
      ...
      if (this.decimalsType == 2) {
        this.counter = new CountUp(this.counterId, this.startVal, endVal, 2, this.duration, {
          useEasing: !this.uneasing,
          useGrouping: this.useGroup,
          separator: this.separator,
          decimal: this.decimal
