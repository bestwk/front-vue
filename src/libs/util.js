...
export const TOKEN_KEY = 'Agent-Token'
...
export const getHomeRoute = routers => {
  ...
  // let role=sessionStorage.getItem('access')

  let homeName = ''
  let flag = pathName.startsWith('/company')

  if (pathName && (pathName === '/admin' || pathName === '/home' || flag)) {
    homeName = 'home'
  } else {
    homeName = 'index'
  }
...
/**
 * @param {*} access 用户权限数组，如 ['mall', 'admin']
 * @param {*} route 路由列表
 */
